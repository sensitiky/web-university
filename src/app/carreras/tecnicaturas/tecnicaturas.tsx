...
const tecnicaturas: Tecnicaturas[] = [
  ...
  {
    nombre: "Técnico superior en seguridad e Higiene laboral y Ambiental",
    descripcion:
      "Capacítate en la implementación de normas de seguridad e higiene laboral y ambiental para garantizar entornos de trabajo seguros y saludables.",
    href: "/tecnicaturas/techigiene",
    imagen: "/higiene.webp",
    alt: "tecnicatura higiene y ambiental",
  },
];
